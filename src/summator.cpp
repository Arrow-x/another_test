...
Summator::Summator() : max_speed(0.0), count(0), mode(0), my_angle(0.0), speeds(0.0), mesh_instance(nullptr) {}
...
auto Summator::_bind_methods() -> void {
	...
	REG_HINT(Summator, Variant::NODE_PATH, example_node_path, PROPERTY_HINT_NODE_PATH_VALID_TYPES, "AnimatedSprite2D")
